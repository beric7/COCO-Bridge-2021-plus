...
def mAP_Results(parent_directory, evaluation_image_directory, minOverLap, ID):
    
    CURDIR = parent_directory
    
    # if there are no images then no animation can be shown
    # \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    img_path = evaluation_image_directory
    # /////////////////////////////////////////////////////////////////////////
    
    show_animation = True

    """
     Create a "mAP_tmp_files/" and "mAP_results/" directory
    """
    # \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    tmp_files_path = CURDIR + "/Results_Output/" + "IOU_" + str(minOverLap) + "_Thres_" + ID + "_mAP_tmp_files"
    if not os.path.exists(tmp_files_path): # if it doesn't exist already
      os.makedirs(tmp_files_path)
    results_files_path = CURDIR + "/Results_Output/mAP_results_" + "IOU_" + str(minOverLap) + "_Thres_" + ID
    ...
    # \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    ground_truth_files_list = glob.glob(CURDIR + '/Metrics_Eval_txt/*.txt')
    # ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for txt_file in ground_truth_files_list:
      ...
      if not os.path.exists(CURDIR + '/Metrics_Eval_txt/' + file_id + ".txt"):
    ...
    # \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    predicted_files_list = glob.glob(parent_directory + "Threshold_%/" + ID + '_Metrics_Detect_txt/*.txt')
    # //////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    for class_index, class_name in enumerate(gt_classes):
      ...
      for txt_file in predicted_files_list:
        ...
        if class_index == 0:
          if not os.path.exists(CURDIR + "/" + 'Metrics_Eval_txt/' + file_id + ".txt"):
            error_msg = "Error. File not found: " + "/Metrics_Eval_txt/" +  file_id + ".txt\n"
            error_msg += "(You can avoid this error message by running extra/intersect-gt-and-pred.py)"
            error(error_msg)
